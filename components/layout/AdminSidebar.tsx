 ...
 * 
 * Navigation sidebar for HR Admin dashboard
...
function AdminSidebarComponent() {
  ...
  return (
    <aside className="w-64 border-r bg-white h-screen sticky top-0 flex flex-col" role="navigation" aria-label="Admin navigation">
      {/* Logo */}
